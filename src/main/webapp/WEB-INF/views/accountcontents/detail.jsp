...
<div class="text-end row">
	<a href="/accountcontents/createForm?ai_number=${aiDTO.ai_number}">내역 추가</a>
</div>
<div class="row">
	<div class="col-3">
		선택한 은앵
		...
		<table>
			...
			<c:forEach items="acDTO" var="a">
				<tr> 진행 
					...
					<td>
						<a href="/accountcontents/update?ai_number=${ac.ac_number}">수정</a>
					</td>
				</tr>
			</c:forEach>
		</table>
