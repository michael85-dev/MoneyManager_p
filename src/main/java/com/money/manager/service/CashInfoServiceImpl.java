...
public class CashInfoServiceImpl implements CashInfoService {
	...
	@Override
	public void create(CashInfoDTO siDTO, long s_number) throws IllegalStateException, IOException {
		// TODO Auto-generated method stub
		long asset = sr.detail(s_number).getS_tAsset();
		
		asset = asset + siDTO.getSi_pAsset();
		
		sr.detail(s_number).setS_tAsset(asset);
	...
	@Override
	public void updatae(CashInfoDTO siDTO, long s_number) throws IllegalStateException, IOException {
		// TODO Auto-generated method stub
		long asset = sr.detail(s_number).getS_tAsset();
		
		asset = asset - sir.detail(s_number).getSi_tAsset();
		
		asset = asset + siDTO.getSi_tAsset();
